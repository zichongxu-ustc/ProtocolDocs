...
class CssMinimizerPlugin {
  ...
  static isSupportsWorkerThreads(implementation) {
    return typeof implementation.supportsWorkerThreads !== "undefined" ? implementation.supportsWorkerThreads() !== false : true;
  }
    ...
    if (optimizeOptions.availableNumberOfCores > 0) {
      ...
      getWorker = () => {
        ...
        new Worker(require.resolve("./minify"), {
          ...
          enableWorkerThreads: Array.isArray(this.options.minimizer.implementation) ? this.options.minimizer.implementation.every(item => CssMinimizerPlugin.isSupportsWorkerThreads(item)) : CssMinimizerPlugin.isSupportsWorkerThreads(this.options.minimizer.implementation)
        });
